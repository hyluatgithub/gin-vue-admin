  ...
  <div>
        ...
        <el-collapse-item name="1">
          ...
          <el-form ref="getTableForm" style="margin-top:24px" :inline="true" :model="dbform" label-width="120px">
            <el-form-item label="业务库" prop="selectDBtype">
              ...
              <el-select v-model="dbform.businessDB" clearable style="width:194px" placeholder="选择业务库"
                         @change="getDbFunc">
                <el-option
    ...
    <div class="ecovacs-search-box">
      ...
      <el-form ref="autoCodeForm" :rules="rules" :model="form" label-width="120px" :inline="true">
        ...
        <el-form-item>
          <template #label>
            <el-tooltip content="注：会自动在结构体添加 created_by updated_by deleted_by，方便用户进行资源权限控制"
                        placement="bottom" effect="light">
              <div> 创建资源标识
                <el-icon>
                  <QuestionFilled/>
    ...
    <div class="ecovacs-table-box">
      ...
      <!-- 组件列表 -->
      <div class="ecovacs-btn-list justify-end mt-4">
...
import {toHump, toLowerCase, toSQLLine, toUpperCase} from '@/utils/stringFun'
import {createTemp, getColumn, getDB, getMeta, getPackageApi, getTable, preview} from '@/api/autoCode'
