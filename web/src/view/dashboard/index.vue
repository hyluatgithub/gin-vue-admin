<template>
  <div class="page">
    <div class="ecovacs-card-box">
      <div class="ecovacs-card ecovacs-top-card">
        <div class="ecovacs-top-card-left">
          <div class="ecovacs-top-card-left-title">早安，管理员，请开始一天的工作吧</div>
          <div class="ecovacs-top-card-left-dot">{{ weatherInfo }}</div>
          ...
          <div>
            <div class="ecovacs-top-card-left-item">
              使用教学：
              <a
                  style="color:#409EFF"
                  target="view_window"
        ...
        <img src="@/assets/dashboard.png" class="ecovacs-top-card-right" alt>
      </div>
    </div>
    <div class="ecovacs-card-box">
      <div class="ecovacs-card quick-entrance">
        <div class="ecovacs-card-title">快捷入口</div>
        <el-row :gutter="20">
          <el-col
    ...
    <div class="ecovacs-card-box">
      <div class="ecovacs-card">
        <div class="ecovacs-card-title">数据统计</div>
        <div class="p-4">
          <el-row :gutter="20">
            <el-col :xs="24" :sm="18">
              <echarts-line/>
